...
Window.clearcolor = (0.57, 0.57, 0.57, 1)
...
class PulseScr(Screen):
    def __init__(self, **kwargs):
        ...
        self.btn = Button(text='Продолжить', size_hint = (0.3, 0.3), pos_hint = {'center_x': 0.5})
        self.btn.on_press = self.next
        outer = BoxLayout(orientation='vertical', padding = 8, spacing = 8)
        outer.add_widget(instr)
...
class PulseScr2(Screen):
    def __init__(self, **kwargs):
        ...
        lbl_result1 = Label(text = "Pезультат:", halign = 'right')
        self.in_result1 = TextInput(text='0', multiline=False)
        line1.add_widget(lbl_result1)
        line1.add_widget(self.in_result1)
        line2 = BoxLayout(size_hint=(0.8, None), height='30sp')
        lbl_result2 = Label(text = "Pезультат после отдыха:", halign = 'right')
        ...
        self.btn = Button(text='Начать', size_hint = (0.3, 0.3), pos_hint = {'center_x': 0.5})
        self.btn.on_press = self.next
        outer = BoxLayout(orientation='vertical', padding = 8, spacing = 8)
        outer.add_widget(instr)
